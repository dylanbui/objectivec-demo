...
-(void)presentSemiViewControllerDefaultPickerOption:(UIViewController*)vc {
...
//                      : semiViewFrame);
        ...
        if (transitionStyle == KNSemiModalTransitionStyleSlideUp) {
            ...
            view.frame = CGRectOffset(semiViewFrame, 0, -20);
            view.alpha = 0.0;
        }
        ...
        [UIView animateWithDuration:duration animations:^{
            if (transitionStyle == KNSemiModalTransitionStyleSlideUp
                || transitionStyle == KNSemiModalTransitionStyleSlideDown) {
