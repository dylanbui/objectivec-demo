...
@property (nonatomic) AVCaptureFlashMode cameraFlashMode;
...
// -- Resume session button, when session try-catch session error --
// -- Khong su dung --
...
// Add them handle xu ly khi thay doi giua  front & back camera
//- (IBAction)changeCamera:(id)sender
//- (void)changeCamera:(void (^)())completeHandler
...
// -- Phai viet lai cho chup hinh nay --
//- (IBAction)capturePhoto:(id)sender
//- (void)capturePhoto:(void (^)(CMSampleBufferRef imageDataSampleBuffer, NSError *error))handler
...
- (void)capturePhoto:(void (^)(AVCapturePhotoSettings *requestedPhotoSettings, NSData *photoData, NSError *error))captureHandler
{
    ...
    dispatch_async( self.sessionQueue, ^{
        ...
        photoSettings.flashMode = self.cameraFlashMode;
...
//        }
        ...
        AVCamPhotoCaptureDelegate *photoCaptureDelegate = [[AVCamPhotoCaptureDelegate alloc] initWithRequestedPhotoSettings:photoSettings willCapturePhotoAnimation:^{
            ...
            dispatch_async( dispatch_get_main_queue(), ^{
                // Call back funciton
                captureHandler(photoCaptureDelegate.requestedPhotoSettings ,photoCaptureDelegate.photoData ,nil);
            } );
        }];
...
// -- try - catch session runtime error --
