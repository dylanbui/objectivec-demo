...
{
    ActivityIndicatorButtonAlignment _activityIndicatorAlignment;
}
...
- (void)setAutoUseActivityIndicatorForDisableState:(BOOL)use
{
    _autoUseActivityIndicatorForDisableState = use;
}

- (void)setEnabled:(BOOL)enabled
{
    [super setEnabled:enabled];
    if (_autoUseActivityIndicatorForDisableState) {
        [self setLoading:!self.enabled];
    }
}
...
- (void)commonInit
{
    _autoUseActivityIndicatorForDisableState = NO;
    _loading = NO;
    _hideImageWhenLoading = YES;
    _hideTextWhenLoading  = YES;
    _activityIndicatorAlignment = ActivityIndicatorButtonAlignmentCenter;
...
- (CGRect)frameForActivityIndicator
{
    ...
    switch (_activityIndicatorAlignment) {
        case ActivityIndicatorButtonAlignmentLeft:
        {
            ...
            break;
        case ActivityIndicatorButtonAlignmentCenter:
        {
            frame.origin.x = ((self.frame.size.width - frame.size.width) / 2);
        }
            break;
        case ActivityIndicatorButtonAlignmentRight:
        {
