...
@interface PTPhotoViewController ()

@end

@implementation PTPhotoViewController
...
{
    PTPhotoDetailViewController *vcl = [[PTPhotoDetailViewController alloc] init];
