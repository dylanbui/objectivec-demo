...
open class DKImagePickerController : UINavigationController {
    ...
    /// Custom autoDismissViewController
    public var autoDismissViewController = true
    ...
    open func dismiss(animated flag: Bool) {
        // Fix : When add DKImagePickerController to subview, dont have self.presentingViewController
